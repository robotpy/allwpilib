...
public class QuadratureEncoder implements CounterBase, PIDSource, Sendable, AutoCloseable {
  ...
  private void initEncoder(boolean reverseDirection, final EncodingType type) {
    ...
    SendableRegistry.addLW(this, "QuadratureEncoder", fpgaIndex);
  }
   ...
   */
  public QuadratureEncoder(final int channelA, final int channelB) {
   ...
   *
   * @return The QuadratureEncoder's FPGA index.
   */
